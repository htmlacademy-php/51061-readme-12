        ...
        <section class="post-details">
            ...
            <div class="post-details__wrapper <?= $type ?>">
                <div class="post-details__main-block post post--details">
                    ...
                    <?php switch ($type) {
                        case "post-link":
                            print(include_template('post-detail/link.php', [
                                'content' => $content,
                                'title' => $title
                            ]));
                            break;
                        case "post-text":
                            print(include_template('post-detail/text.php', [
                                'content' => $content
                            ]));
                            break;
                        case "post-video":
                            print(include_template('post-detail/video.php', [
                                'content' => $content
                            ]));
                            break;
                        case "post-photo":
                            print(include_template('post-detail/photo.php', [
                                'content' => $content
                            ]));
                            break;
                        case "post-quote":
                            print(include_template('post-detail/quote.php', [
                                'content' => $content,
                    ...
                    <div class="comments">
                        <form class="comments__form form" action="#"
                            ...
                            <div
                                class="form__input-section form__input-section--error">
                                <textarea
                                ...
                                <li class="comments__item user">
                                    ...
                                    <div class="comments__info">
                                        ...
                                        <p class="comments__text">
                                            ...
                                            монгольской
                                            границы. Байкал считается самым
                                            глубоким озером в мире. Он окружен
                                            сетью
                                            пешеходных маршрутов, называемых
                                            Большой байкальской тропой. Деревня
                                            Листвянка, расположенная на западном
                                            берегу озера, – популярная отправная
                                            точка для летних экскурсий. Зимой
                                            здесь можно кататься на коньках и
                                            собачьих
                                            упряжках.
                                        </p>
                                    </div>
