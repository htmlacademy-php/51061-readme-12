                        ...
                        <header class="post__header post__author">
                            <a class="post__author-link" href="#" title="Автор">
                                ...
                                <div class="post__info">
                                    <b class="post__author-name">Эльвира
                                        Хайпулинова</b>
                    ...
                    <article class="feed__post post post-text">
                        <header class="post__header post__author">
                            <a class="post__author-link" href="#" title="Автор">
                                ...
                                <div class="post__info">
                                    <b class="post__author-name">Таня
                                        Фирсова</b>
                        ...
                        <div class="post__main">
                            ...
                            <p>
                                ...
                                Сибири к северу от
                                монгольской границы. Байкал считается самым
                                глубоким озером в
                                мире. Он окружен сетью пешеходных маршрутов,
                                называемых Большой
                                байкальской тропой. Деревня Листвянка,
                                расположенная на западном
                                берегу озера, – популярная отправная точка для
                                летних экскурсий.
                    ...
                    <article class="feed__post post post-video">
                        ...
                        <div class="post__main">
                            <div class="post-video__block">
                                ...
                                <button class="post-video__play-big button"
                                        type="button">
                    ...
                    <article class="feed__post post post-link">
                        <header class="post__header post__author">
                            <a class="post__author-link" href="#" title="Автор">
                                ...
                                <div class="post__info">
                                    <b class="post__author-name">Лариса
                                        Роговая</b>
